...
//	datatable2
	if ($("#data-table2")[0]) {
      $("#data-table2").DataTable({
        ...
        buttons: [{
          extend: "excelHtml5",
          title: "NAIROBI CITY COUNTY EXCEL DOC"
        }, {
          extend: "csvHtml5",
          title: "NAIROBI CITY COUNTY HTML DOC"
        }, {
          extend: "print",
          title: "NCCG Search Result"
        }],
        initComplete: function (a, b) {
          $(this).closest(".dataTables_wrapper").find(".dataTables__top").prepend('<div class="dataTables_buttons hidden-sm-down actions"><span class="actions__item zmdi zmdi-print" data-table-action="print" /><span class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><a href="" class="dropdown-item" data-table-action="excel">Excel (.xlsx)</a><a href="" class="dropdown-item" data-table-action="csv">CSV (.csv)</a></ul></div></div>')
        }
  ...
  $(document).ready(function(){
      function anim1(){
        $('.anim-1').addClass('bounceInDown').addClass('opacity-1');
      }
      function anim0(){
        $('.anim-0').addClass('rubberBand').addClass('opacity-1');
      }
      function anim2(){
        $('.anim-2').addClass('fadeInLeft');
      }

      function anim3(){
        $('.anim-3').addClass('fadeInLeft');
      }

      function anim4(){
        $('.anim-4').addClass('fadeInLeft');
      }

      function anim5(){
        $('.anim-5').addClass('fadeInLeft');
      }
      function anim7(){
        $('.anim-7').addClass('fadeInDownBig');
      }

      function anim6(){
        $('.anim-6').addClass('bounceInUp').addClass('opacity-1');
      }
      setTimeout(anim0,800);
      setTimeout(anim1,900);
      setTimeout(anim2,1000);
      setTimeout(anim3,1200);
      setTimeout(anim4,1200);
      setTimeout(anim5,1300);
      setTimeout(anim6,1400);
      setTimeout(anim7,1700);
